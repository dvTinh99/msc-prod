...
elseif ( $rating_count >= 0 ) : ?>
        <div class="star__" style="float: left;">
			<span><i class="fa-solid fa-star" style="font-weight: normal;"></i></span>
			<span><i class="fa-solid fa-star" style="font-weight: normal;"></i></span>
			<span><i class="fa-solid fa-star" style="font-weight: normal;"></i></span>
			<span><i class="fa-solid fa-star" style="font-weight: normal;"></i></span>
			<span><i class="fa-solid fa-star" style="font-weight: normal;"></i></span>
			<span class="woocommerce-review-link">(<span class="count">0</span> đánh giá)</span>
		</div>  
<?php endif; ?>

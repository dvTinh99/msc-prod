<div class="row row-small category-page-row">
		...
		<div class="col large-3  <?php flatsome_sidebar_classes(); ?>">
			<?php 
				if(!empty(single_cat_title("", false))){
					?><h3 class="title_cate hide-for-medium"><?php single_cat_title(''); ?></h3>
			<?php	}else{
					echo '<h3 class="title_cate hide-for-medium">Sản phẩm</h3>';
				}
			?>
